...
<!-- example -->
```jsx
import { List, ListItem, ListSubHeader, ListDivider, ListCheckbox } from 'nextrap/components/list';

const ListTest = () => (
  <List selectable ripple>
    <ListItem
      avatar='https://pbs.twimg.com/profile_images/1121220551/Peter_Thiel_400x400.jpg'
      caption='Peter Thiel'
      rightIcon='more_vert'
    />
    <ListItem
      avatar='https://pbs.twimg.com/profile_images/653533858453811200/Zm8P8_k0_400x400.jpg'
      caption='Richard Branson'
      rightIcon='more_vert'
    />
    <ListItem
      avatar='https://pbs.twimg.com/profile_images/718273532438966274/j0h7TkOS_400x400.jpg'
      caption='Elon Musk'
      rightIcon='mail'
    />
  </List>
