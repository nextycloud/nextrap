...
<!-- example -->
```jsx
import Dropdown from 'nextrap/components/dropdown';

const people = [
  { value: 'Tracy Pearson', label: 'CEO', img: 'https://randomuser.me/api/portraits/men/27.jpg' },
  { value: 'Kylie Caldwell', label: 'Marketing', img: 'https://randomuser.me/api/portraits/women/55.jpg' },
  { value: 'Dylan Murphy', label: 'Product manager', img: 'https://randomuser.me/api/portraits/men/46.jpg' },
  { value: 'Layla Austin', label: 'Product manager', img: 'https://randomuser.me/api/portraits/women/12.jpg' }
];

class DropdownTest extends React.Component {
  state = { value: 'Tracy Pearson' };
